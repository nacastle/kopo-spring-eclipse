...
<title>하피 - 모두를 위한 경매</title>
 ...
 <body style="background: #177e6a; color: white;">
    ...
    <div class="container-fluid" style="text-align: center;"> <!--  style="text-align: center; padding-top: 8rem; color: #27b2a5;"> -->
    	<p style="font-weight: bold; font-size: 1rem; margin-top: 4rem;">입금할 때 입력할 암호입니다.<br>(숫자 4자리 + 영문 1자리)</p>
    	
    	<div class="mb-3" style="text-align: center;">
<!--               <label for="address">상위주소</label> -->
			<form action="${pageContext.request.contextPath }/pwdSettingSuccess" name="pForm" method="post">
